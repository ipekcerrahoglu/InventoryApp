...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If the intent DOES NOT contain a prroduct content URI, then we know that we are
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.supplier_amazon))) {
                        mSupplier = ProductEntry.SUPPLIER_AMAZON;
                    } else if (selection.equals(getString(R.string.supplier_ebay))) {
                        mSupplier = ProductEntry.SUPPLIER_EBAY;
                    }
                }
            }
