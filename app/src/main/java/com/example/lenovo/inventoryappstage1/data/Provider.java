...
public class Provider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (supplierName == null || !ProductEntry.isValidSupplier(supplierName)) {
        ...
        if (phone == null || phone < 0) {
            Toast.makeText(getContext(), "Product requires a supplier phone number", Toast.LENGTH_SHORT).show();
        }
